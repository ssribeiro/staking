...
export const SMART_CONTRACT_STAKING_0_MONTH = {
    address: import.meta.env.VITE_SMART_CONTRACT_STAKING_0_MONTH,
    abi: [
        {
            "inputs": [
                {
...
export const SMART_CONTRACT_STAKING_1_MONTH = {
    address: import.meta.env.VITE_SMART_CONTRACT_STAKING_1_MONTH,
    abi: [
        {
            "inputs": [
                {
...
export const SMART_CONTRACT_STAKING_3_MONTH = {
    address: import.meta.env.VITE_SMART_CONTRACT_STAKING_3_MONTH,
    abi: [
        {
            "inputs": [
                {
...
export const SMART_CONTRACT_STAKING_6_MONTH = {
    address: import.meta.env.VITE_SMART_CONTRACT_STAKING_6_MONTH,
    abi: [
        {
            "inputs": [
                {
